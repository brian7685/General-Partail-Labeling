...
def globally_normalize_bipartite_adjacency(adjacencies, verbose=False, symmetric=True):
    ...
    else:#run this, dot is matrix product
...
def load_data_monti(dataset, testing=False):
    ...
    np.random.seed(42)
    np.random.shuffle(list(rand_idx))
...
def load_official_trainvaltest_split(dataset, testing=False):
    ...
    print(data_array[:, 2].astype(dtypes['ratings']))
    ...
    a = u_features
    """
    u_features = np.load('/Users/brian/name_dataset/face_feature.npy')
    v_features = np.load('/Users/brian/name_dataset/name_feature.npy')
    u_features = sp.csr_matrix(u_features)
    v_features = sp.csr_matrix(v_features)
    rating_mx_train = np.load('/Users/brian/name_dataset/rating.npy')
    rating_mx_train = sp.csr_matrix(rating_mx_train)
    u_train_idx = np.load('/Users/brian/name_dataset/u_train_idx.npy')
    v_train_idx = np.load('/Users/brian/name_dataset/v_train_idx.npy')
    train_labels = np.load('/Users/brian/name_dataset/train_labels.npy')
    print("User features shape: "+str(u_features.shape))
    print("Item features shape: "+str(v_features.shape))
    print(u_train_idx.shape)
    print(v_train_idx.shape)
    print(train_labels.shape)
    #multiply 4 if rate = 1~5
    #train_labels = train_labels*4
    #rating_mx_train = rating_mx_train*4
    test_labels = np.load('/Users/brian/name_dataset/test_labels.npy')
    u_test_idx = np.load('/Users/brian/name_dataset/u_test_idx.npy')
    v_test_idx = np.load('/Users/brian/name_dataset/v_test_idx.npy')
    class_values = np.array([1,2,3,4,5])#np.sort(np.unique(ratings))
    return u_features, v_features, rating_mx_train, train_labels, u_train_idx, v_train_idx, \
        0, 0, 0, test_labels, u_test_idx, v_test_idx, class_values
    #return u_features, v_features, rating_mx_train, train_labels, u_train_idx, v_train_idx, \
    #    val_labels, u_val_idx, v_val_idx, test_labels, u_test_idx, v_test_idx, class_values
